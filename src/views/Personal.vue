          ...
          <div style="padding-top:10px">
            <el-row :gutter="10">
              ...
              <el-col :offset="1" :span="17">
                <div class="grid-content bg-purple" style="text-align:right">{{ userData.username }}</div>
              </el-col>
            </el-row>
            <el-divider/>
            <el-row :gutter="10">
              ...
              <el-col :offset="1" :span="17">
                <div class="grid-content bg-purple" style="text-align:right">{{ userData.chineseName }}</div>
              </el-col>
            </el-row>
            <el-divider/>
            <el-row :gutter="10">
              ...
              <el-col :offset="1" :span="17">
                <div class="grid-content bg-purple" style="text-align:right">{{ (userData.deptName) }}</div>
              </el-col>
            </el-row>
            <el-divider/>
            <el-row :gutter="10">
              ...
              <el-col :offset="1" :span="17">
                <div class="grid-content bg-purple" style="text-align:right">{{ (userData.roleNames) }}</div>
              </el-col>
            </el-row>
            <el-divider/>
            <el-row :gutter="10">
              ...
              <el-col :offset="1" :span="17">
                <div class="grid-content bg-purple" style="text-align:right">{{ (userData.email) }}</div>
              </el-col>
            </el-row>
            <el-divider/>
            <el-row :gutter="10">
              ...
              <el-col :offset="1" :span="17">
                <div class="grid-content bg-purple" style="text-align:right">{{ (userData.phone) }}</div>
              </el-col>
            </el-row>
            <el-divider/>
            <el-row :gutter="10">
        ...
        <el-aside width="100%">
          <el-main>
            <el-card class="box-card">
              ...
              <template>
                <el-form ref="dataForm" :model="dataForm" :rules="dataFormRules" class="demo-ruleForm" label-width="90px"
                         status-icon>
                  <el-form-item label="姓名" prop="chineseName">
                    <el-input v-model="dataForm.chineseName"/>
                  </el-form-item>
                  <el-form-item v-if="dataForm.username.toLowerCase() === admin " label="部门" prop="deptName">
                    <popup-tree-input :currentChangeHandle="deptTreeCurrentChangeHandle" :data="deptData"
