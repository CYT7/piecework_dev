<template>
  <div class="page-container">
    ...
    <el-table :data="tableTreeData" stripe size="mini" style="width: 100%;"
      ...
      <el-table-column prop="orderNum" header-align="center" align="center" min-width="50%" label="排序"/>
    ...
    <el-dialog :title="!dataForm.id ? '新增' : '修改'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm"
               @keyup.enter.native="submitForm()" label-width="80px" :size="size" style="text-align:left;">
