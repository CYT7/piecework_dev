<template>
  <div class="personal-panel">
    <div :style="{'background':this.$store.state.app.themeColor}" class="personal-desc">
      ...
      <div class="register-info"><span class="register-info fa fa-clock-o">创建时间:{{
          this.dateFormat(user.createTime)
        }}</span></div>
    </div>
    <div class="main-operation">
      <span class="main-operation-item" @click="$router.push('/')"><el-button icon="fa fa-male"
                                                                              size="small"> 个人中心</el-button></span>
      <span class="main-operation-item" @click="updatePasswordDialog"><el-button icon="fa fa-key"
                                                                                 size="small"> 修改密码</el-button></span>
    </div>
    ...
    <el-dialog :close-on-click-modal="false" :modal="false" :visible.sync="updatePwdDialogVisible" title="修改密码"
      ...
      <el-form ref="updatePwdDataForm" :model="updatePwdDataForm" :rules="updatePwdDataFormRules" :size="size"
        ...
        <el-form-item label="确认新密码" prop="confirmPassword">
          <el-input v-model="updatePwdDataForm.confirmPassword" auto-complete="off" type="password"></el-input>
        </el-form-item>
      </el-form>
